...
import { QParamsModel } from '../models/q-models/q-params.model';
import { QResultsModel } from '../models/q-models/q-results.model';
...
export class BaseDataSource implements DataSource<BaseModel> {
	...
	baseFilter(_entities: any[], _queryParams: QParamsModel, _filtrationFields: string[] = []): QResultsModel {
		// Filtration
		...
		const queryResults = new QResultsModel();
